...
bienvenida:
    ...
    LD A,1*8+$80      ; Azul parpadeante
    LD B,21         ; Buscamos la dirección del atributo de coordenadas 21,30
    LD C,30         ; Para poner el cursor
    CALL coord_Atrib ; Esta rutina devuelve en HL la dirección del atributo
    LD (HL),A       ; Pongo el atributo

    RET
    CALL tecladoS_N    ; Leo el teclado hasta que pulsen S o N
